...
public class SkeletonSpellBall : UdonSharpBehaviour
{
    ...
    public static void Instantiate(GameObject prefab, GameObject hand, VRCPlayerApi target, Bloodsplat_Object_Pool_Manager bloodpool, shield shieldRef)
    {
        if (hand == null) return;
    ...
    {
        if (!this.m_Target.IsValid()) return;
        bool isShielded = this.m_Shield != null
            && this.m_Shield.m_Pickup != null
            && this.m_Shield.m_Pickup.IsHeld
            && this.m_Shield.m_Pickup.currentPlayer != null
            && this.m_Shield.m_Pickup.currentPlayer.IsValid()
            && this.m_Shield.m_Pickup.currentPlayer.playerId == this.m_Target.playerId;
        ...
        {
            this.m_Shield.Break(this.m_Target);
        }
    }
